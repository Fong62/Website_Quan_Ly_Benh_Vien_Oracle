        ...
        public async Task<IActionResult> OnPostAsync()
        {
            try
            {
                ...
                if (existing == null)
                {
                    ...
                    "BEGIN Sp_AddPhongBan(:p_MaPB, :p_MaBP, :p_TenPhongBan, :p_MoTa); END;",
                    new OracleParameter("p_MaPB", OracleDbType.NVarchar2, 50, PhongBan.MaPb, ParameterDirection.Input),
                    new OracleParameter("p_MaBP", OracleDbType.NVarchar2, 50, PhongBan.MaBp ?? (object)DBNull.Value, ParameterDirection.Input),
                    new OracleParameter("p_TenPhongBan", OracleDbType.NVarchar2, 100, PhongBan.TenPhongBan, ParameterDirection.Input),
                    new OracleParameter("p_MoTa", OracleDbType.NVarchar2, 4000, (object?)PhongBan.MoTa ?? DBNull.Value, ParameterDirection.Input)
               );
                }
                else
                {
