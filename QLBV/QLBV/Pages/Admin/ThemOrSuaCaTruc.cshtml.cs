            ...
            try
            {
                ...
                if (existing == null)
                {
                    await _context.Database.ExecuteSqlRawAsync(
                        "BEGIN Sp_AddCaTruc(:p_MaCT, :p_ThoiGianBT, :p_ThoiGianKT, :p_NVtruc); END;",
                        new OracleParameter("p_MaCT", OracleDbType.NVarchar2, 50, CaTruc.MaCt, ParameterDirection.Input),
                        new OracleParameter("p_ThoiGianBT", OracleDbType.TimeStamp, CaTruc.ThoiGianBt, ParameterDirection.Input),
                        new OracleParameter("p_ThoiGianKT", OracleDbType.TimeStamp, CaTruc.ThoiGianKt, ParameterDirection.Input),
                        new OracleParameter("p_NVtruc", OracleDbType.NVarchar2, 50, CaTruc.Nvtruc, ParameterDirection.Input)
                    );
                }
                else
                {
