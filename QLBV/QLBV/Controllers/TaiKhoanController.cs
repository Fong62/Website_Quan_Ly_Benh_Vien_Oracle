...
namespace QLBV.Controllers
{
    public class TaiKhoanController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                // ✅ Kiểm tra trùng tên đăng nhập trước khi tạo tài khoản hoặc nhân viên
                ...
                return await CreateUserAndRole(model, role, newMaNhanVien); // ⚠️ Trả về từ đây luôn để giữ luồng logic
            }
